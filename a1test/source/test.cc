...
char *dbfile_dir = "/cise/tmp/dbi_sp15/DATA/a1test/"; // dir where binary heap files should be stored
char *tpch_dir ="/cise/tmp/dbi_sp15/DATA/10M/"; // dir where dbgen tpch files (extension *.tbl) can be found
